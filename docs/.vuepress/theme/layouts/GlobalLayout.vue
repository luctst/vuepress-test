<template>
  <div id="moonshot-theme" v-if="$page.path !== ''">
    ...
    <FloatLine
      ...
      :description="floatLineDescription"
...
export default {
  ...
  mounted () {
    switch (this.$page.path) {
      case "/":
        this.floatLineTitle = "Moonshot-internet notre nouvelle punchline de fou";
        ...
        this.floatLineImage = "group@2x.png";
        break;
      case "/career.html":
